...
class TwoStageRequest(_message.Message):
    __slots__ = ["directoryPath", "runExclusive", "firstStageRequestsList", "secondStageRequestsList"]
    DIRECTORYPATH_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, directoryPath: _Optional[str] = ..., runExclusive: bool = ..., firstStageRequestsList: _Optional[_Iterable[_Union[VerificationRequest, _Mapping]]] = ..., secondStageRequestsList: _Optional[_Iterable[_Union[VerificationRequest, _Mapping]]] = ...) -> None: ...
...
class VerificationRequest(_message.Message):
    __slots__ = ["code", "path", "arguments", "timeout"]
    CODE_FIELD_NUMBER: _ClassVar[int]
    PATH_FIELD_NUMBER: _ClassVar[int]
...
class VerificationResponse(_message.Message):
    __slots__ = ["response", "fileName", "executionTimeInMs"]
